...
def surface_bottomMerging(data_dir,output_dir):
    ...
    for i, j in zip(bottom_data,surface_data):
        ...
        pivot=pd.pivot_table(bottom,index=["Year"],values=variables,
                             aggfunc='count')
        ...
        #pivot=pivot.loc[pivot.index != 2008]
        ...
        pivot=pd.pivot_table(surface,index=["Year"],values=variables,
                             aggfunc='count')
...
input_dir="C:\Projects\WGINOSE\Data\wgi_bot_sur\\"
output_folder=r"C:\Projects\WGINOSE\Bottom_Surface_outputs\\"

surface_bottomMerging(input_dir,output_folder)
